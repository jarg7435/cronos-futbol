...
console.log('── PARTE 1 · el árbol aparece en Entrenamientos ──');
{
    ...
    ok('1b · con las 10 categorías (v747)', cuenta(h, /class="ct-tree-cat"/g) === 10,
       cuenta(h, /class="ct-tree-cat"/g));
    ok('1c · y las 30 subcategorías', cuenta(h, /class="ct-tree-sub"/g) === 30);
...
console.log('\n── PARTE 4 · Convocatorias también en árbol ──');
{
    ...
    ok('4b · con las 10 categorías (v747)', cuenta(h, /class="ct-tree-cat"/g) === 10,
       cuenta(h, /class="ct-tree-cat"/g));
