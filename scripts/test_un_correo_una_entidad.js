...
function bloqueExclusividad() {
    const marca = AUTH.indexOf("if (isAddingRole && clubId && finalRole !== 'superadmin') {");
...
{
    const i = AUTH.indexOf("if (isAddingRole && clubId && finalRole !== 'superadmin') {");
