...
function _catLabelInd(cat, sub) {
    if (!cat) return '–';
    const map = { prebenjamin:'Prebenjamín', benjamin:'Benjamín', alevin:'Alevín', infantil:'Infantil', cadete:'Cadete', juvenil:'Juvenil', regional:'Regional', regional_fem:'Regional FEM', futurefem:'FUTureFEM', nacional:'Nacional' };
