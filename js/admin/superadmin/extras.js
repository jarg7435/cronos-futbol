    ...
    function patchSaRequests() {
        ...
        window.saRequests = async function () {
            ...
            try {
                ...
                var CATS    = { prebenjamin: 'Prebenjamín', benjamin: 'Benjamín', alevin: 'Alevín', infantil: 'Infantil', cadete: 'Cadete', juvenil: 'Juvenil', femenino: 'Femenino', regional: 'Regional', regional_fem: 'Regional FEM', futurefem: 'FUTureFEM', nacional: 'Nacional' };
