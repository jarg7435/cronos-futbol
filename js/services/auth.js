...
// importan porque este archivo sigue llamándolos y publicando sus alias.
import { enterApp, showRoleSelection, selectOption } from './auth/role-launch.js';
...
// ── Entrar en la app ──────────────────────────────────────────
// ════════════════════════════════════════════════════════════════════
//  SELECCIÓN DE ROL Y ARRANQUE DE LA APLICACIÓN
//  (enterApp / showRoleSelection / selectOption / _saPickTestClub /
//   _launchWithRole / _renderCoordinatorTypePill)
//  Extraídas a js/services/auth/role-launch.js (auditoría 2026-07-22,
//  monolito #4, paso 1). Se importan arriba, en la cabecera del módulo:
//  este archivo sigue llamando a enterApp() y publicando los tres alias
