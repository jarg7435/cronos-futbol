    ...
    try {
        ...
        for (const cid of _initialClubIds) {
            try {
                ...
                console.warn('[StaffDashboard][DIAG] No se pudieron buscar usuarios con clubId', cid, ':', e.code || e.message);
            }
        }
        ...
        try {
            ...
            console.warn('[StaffDashboard][DIAG] Búsqueda por email falló:', e.code || e.message);
        }

        console.log('[StaffDashboard][DIAG] clubIds a consultar:', [..._allClubIds]);
        ...
        for (const cid of _allClubIds) {
            try {
                ...
                console.log('[StaffDashboard][DIAG] Query por clubId', cid, '→', count, 'docs');
            } catch (clubErr) {
                console.warn('[StaffDashboard][DIAG] Query por clubId', cid, 'FALLÓ:', clubErr.code || clubErr.message);
            }
        }
        ...
        console.log('[StaffDashboard][DIAG] Total docs:', _clubQueryDocCount, 'staffReport=true:', _staffDocCount);
